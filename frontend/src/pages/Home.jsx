...
const Home = () => {
  ...
  return (
    <div style={{ background: '#0a0a0f', color: 'white', position: 'relative' }}>
      <ParticleBackground />
      ...
      >
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '1100px' }}>
          ...
          >
            ...
            <span style={{ color: '#22c55e', fontWeight: 600 }}>3.7x ROI</span>,{' '}
            <span style={{ color: '#3b82f6', fontWeight: 600 }}>40% productivity gains</span>, and measurable results in weeks.
          </p>
          ...
          >
            {[
              ...
              <div key={i} style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '0.875rem', fontWeight: 600, color: '#9333ea', marginBottom: '0.25rem' }}>
                  {stat.value}
                </div>
